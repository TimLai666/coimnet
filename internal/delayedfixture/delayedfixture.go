// Package delayedfixture contains the single implementation of the delayed-association fixture so checkpoint tests do not need to import experiment.
...
// Mix applies the SplitMix64 mixing function used by delayed fixture seeds.
...
// LIFCore fixes the spiking counterpart of NewDelayedTrainer's topology:
